...
const CardStyles = {
  style1: 'bg-cyan-50 rounded-sm shadow-sm p-4 m-7 w-72 size-40 text-teal-600 text-semibold text-xs',
  style2: 'bg-purple-50 rounded-sm shadow-sm p-4 m-7 w-72 size-40 text-purple-600 text-semibold text-xs',
  style3: 'bg-blue-50 rounded-sm shadow-sm p-4 m-6 w-72 size-40 text-blue-600 text-semibold text-xs',
