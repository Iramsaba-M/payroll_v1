...
export const TypeOfLoan = [
  ...
  export const Loanpolicycontent = [
    { card: 'style1',path:'./LoanPolicy', title: 'Loan Policy',icon:<TbArrowBigRight className="ml-5" />,icon2:<RiLock2Line className="h-7 w-6 -ml-16 "/> },
  ]
    export const LoanApprovalSettings = [
      { card: 'style1',path:'./LoanApprovalSettings', title: 'Loan Approval Settings',icon:<TbArrowBigRight className="ml-5" />,icon2:<IoSettingsOutline className="h-7 w-6 ml-10 "/> },
