...
const UserAppMenus = () => {
  ...
  return (
    <>
      <ul className="fixed   h-screen  w-44">
         <div className="appname py-2 h-13 text-bold text-4xl  text-[#6366F1]  bg-white font-mono font-bold ml-5  mb-4  "  > {/*text-white  onClick={() => setshownav(!shownav)}    */ }
          iKamai
        </div>
