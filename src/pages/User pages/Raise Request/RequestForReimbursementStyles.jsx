const RequestForReimbursementStyles = {
  ...
  standard_document: {
      ...
      label: 'block text-gray-600 lg:text-xs font-bold my-1 text-sm', 
      input: 'border hover:border-blue-500 border-black bg-transparent text-gray lg:text-xs my-2 mr-24 mb-2 px-2 py-1 w-[30vh] leading-tight focus:outline-none rounded-sm h-10 text-sm',//mr-14
  ...
  boxInput: 'bg-white-50 border border-blue-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2 dark:bg-white-700 dark:border-blue-600 dark:placeholder-blue-400 dark:text-black dark:focus:ring-blue-500 dark:focus:border-blue-500',
