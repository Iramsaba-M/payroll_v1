      ...
      >
        ...
        {(
          <>
            ...
            >
              <FaPlay size={25} className="text-gray-400 ml-3  rotate-180 " />
            </button>
            <button
            ...
            >
              <FaPlay size={25} className="text-gray-400 ml-3" />
            </button>
          </>
        )}
      </div>
  ...
  return (
    <div >
      {!applyleave && (<div className='ml-28 mt-5  '>
        ...
        <div className='flex w-[130vh] justify-between px-4 bg-gray-200  rounded-xl shadow-sm border-gray-100 '>
        ...
        <div className='mt-6 '>
          ...
          <Calendar
            onChange={onChange}
            value={value}
            className="border-2 shadow-xl bg-white border-gray-100 rounded-md w[100vh] h[30vh] bg text-center text-xl py-3" //hover:border-blue-500
