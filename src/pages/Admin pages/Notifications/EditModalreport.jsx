...
import { Reimbrusement_notification_patch } from '../../../api/EndPoints';

const EditModalreport = ({ employee_id }) => {
  ...
  const handleSave = async (status) => {
    ...
    try {
      const result = await patchData(`${Reimbrusement_notification_patch}${employee_id}`, data);
...
export default EditModalreport;
